 ...
 */
PlotterStepperDriver::PlotterStepperDriver(int steps, int dir_pin, int step_pin)
:motor_steps(steps), dir_pin(dir_pin), step_pin(step_pin)
{
    init();
}

void PlotterStepperDriver::init(void){
...
void PlotterStepperDriver::calcStepPulse(void){
 ...
 */
void PlotterStepperDriver::setRPM(unsigned rpm){
    this->rpm = rpm;
    calcStepPulse();
}
 ...
 * Allowed ranges for PlotterStepperDriver are 1:1 to 1:128
 */
unsigned PlotterStepperDriver::setMicrostep(unsigned microsteps){
 ...
 */
void PlotterStepperDriver::setDirection(int direction){
 ...
 */
int PlotterStepperDriver::move(int steps){
 ...
 */
int PlotterStepperDriver::rotate(int deg){
 ...
 */
int PlotterStepperDriver::rotate(double deg){
